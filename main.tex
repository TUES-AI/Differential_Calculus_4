...
\hline
Произведение & $\log_{\base{a}}(\argu{x}y)=\log_{\base{a}}\argu{x}+\log_{\base{a}}y$ \\
\hline
Частно & $\log_{\base{a}}\!\left(\dfrac{\argu{x}}{y}\right)=\log_{\base{a}}\argu{x}-\log_{\base{a}}y$ \\
\hline
Степен & $\log_{\base{a}}(\argu{x}^r)=r\,\log_{\base{a}}\argu{x}\quad (r\in\mathbb{R})$ \\
\hline
Смяна на основата & $\displaystyle \log_{\base{a}}\argu{x}=\frac{\ln\argu{x}}{\ln\base{a}}$ \\
\hline
